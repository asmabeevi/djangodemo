...
def order_form(request):
    if request.method=="POST":
        ...
        client=razorpay.Client(auth=('rzp_test_494woe1AGdkUFT','03WPu58rdrwxElCnqZrKq5Xp')) # create a client connection
...
def payment_status(request,u):
    ...
    if(request.method=="POST"):
        ...
        client = razorpay.Client(auth=('rzp_test_494woe1AGdkUFT', '03WPu58rdrwxElCnqZrKq5Xp'))
        print(client)
        try:
